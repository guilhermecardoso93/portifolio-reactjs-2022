...
import { faInstagram } from '@fortawesome/free-solid-svg-icons/brands'
            ...
            <div className="social-icon">
              <ul>
                <li>
                  ...
                  >
                    <InstagramLogo size={32} color="#fff" className='icon'/>
                  </a>
                </li>
                <li>
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <Envelope size={32} color="#fff" className='icon' />
                  </a>
                </li>
                <li>
                <a
                ...
                rel="noopener noreferrer"
              >
                <WhatsappLogo size={32} color="#fff" className="icon" />
              </a>
                </li>
                <li>
 <a
                ...
                rel="noopener noreferrer"
              >
                <FontAwesomeIcon icon={faInstagram} className="highlight"/>
              </a>
                </li>
              </ul>
